                      ...
                      @endif
                        <form method="POST" action="{{ route('place_create') }}">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <input id="place_name" type="text" class="place_add_form" name="place_name" value="{{ old('place_name') }}">
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <input id="place_furigana" type="text" class="place_add_form" name="place_furigana" value="{{ old('place_furigana') }}">
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <input id="place_tel" type="tel" maxlength="11" pattern="[\d]*" class="place_add_form" name="place_tel" value="{{ old('place_tel') }}" placeholder="ハイフンなしで入力してください">
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <select id="place_cat" name="place_cat" type="text" class="place_add_form" value="{{ old('place_cat') }}">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <input id="place_postcode" type="text" name="place_postcode" size="10" class="place_add_form" value="{{ old('place_postcode') }}" maxlength="8" onKeyUp="AjaxZip3.zip2addr(this,'','place_prefecture','place_city');">
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <select id="place_prefecture" type="text" name="place_prefecture"class="place_add_form" value="{{ old('place_prefecture') }}">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <input id="place_city" type="text" name="place_city" size="60" class="place_add_form" value="{{ old('place_city') }}" maxlength="8">
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <input id="place_block" type="text" name="place_block" class="place_add_form" value="{{ old('place_block') }}">
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <textarea id="place_busihours" type="text" name="place_busihours" class="place_add_form" value="{{ old('place_busihours') }}" rows="8" cols="80" placeholder="例     [月〜金]10:00〜21:00
         [土・日・祝]9:00〜22:00"></textarea>
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <input id="place_holiday" type="text" name="place_holiday" class="place_add_form" value="{{ old('place_holiday') }}" placeholder="例     不定休">
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <select id="place_budget" type="text" name="place_budget" class="place_add_form" value="{{ old('place_budget') }}">
